...
if (isset($_POST['P_Id'], $_POST['password'], $_POST['confirmpassword'], $_POST['patientName'], $_POST['mob'], $_POST['gender'], $_POST['age'], $_POST['occupation'], $_POST['address'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($tempFilename, $uploadDir . $newFilename)) {
            ...
            $getImageSql = "SELECT image FROM loginp WHERE P_Id = :P_Id";
    ...
    $sql = "UPDATE loginp SET password = :password, name = :patientName, mob = :mob, gender = :gender, age = :age, occupation = :occupation, address = :address, image = :image WHERE P_Id = :P_Id";
