...
function PatDashboard() {
  ...
  const { id, name, mail, P_Id, doctorId, age, mob, occupation } = route.params;
  ...
  const goToPatMenu = () => {
    navigation.navigate('PatMenu', { doctorId, id, name, mail, P_Id, age, occupation, mob });
  };
        ...
        <View style={styles.outerContainer}>
          ...
          <View style={styles.buttonsContainer}>
            ...
            <View style={styles.buttonsRow}>
              <TouchableOpacity style={[styles.button, { marginBottom: 10 }]} onPress={navigateToExercises}>
                <Image
                  source={{
