...
if (isset($_POST['doctorId'], $_POST['password'], $_POST['doctorname'], $_POST['phoneno'], $_POST['email'], $_POST['gender'], $_POST['age'], $_POST['experience'], $_POST['specialization'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($tempFilename, $uploadDir . $newFilename)) {
            ...
            $sql = "UPDATE logind SET password = :password, doctorname = :doctorname, phoneno = :phoneno, email = :email, gender = :gender, age = :age, experience = :experience, specialization = :specialization, image = :image WHERE doctorId = :doctorId";
        } else {
        ...
        $sql = "UPDATE logind SET password = :password, doctorname = :doctorname, phoneno = :phoneno, email = :email, gender = :gender, age = :age, experience = :experience, specialization = :specialization WHERE doctorId = :doctorId";
    }
